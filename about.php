...
<style type="text/css">
.single-page-title {
    background: url(img/about-marathon.jpg) no-repeat bottom;
             ...
             <div class="col-sm-6 col-md-4">
                <div class="promo-block-wrapper clearfix">
                    ...
                    <div class="promo-content">
                        ...
                        <p>We at The Big Beach Marathon help you stay fit, let you track your progress, get you networking with other runners and get you to join our chapters in various cities for a healthier life!</p>
                    </div>
                </div>
                <!-- /.promo-block-wrapper -->
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="promo-block-wrapper clearfix">
                    ...
                    <div class="promo-content">
                        ...
                        <p>Our Indian chapters have grown to include six places with more to be added in the coming future. We now have groups that get together to plan daily routes and run together in Chennai, Mumbai, Bengaluru, Pune, Goa and Pondicherry.</p>
                    </div>
                </div>
                <!-- /.promo-block-wrapper -->
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="promo-block-wrapper clearfix">
                    ...
                    <div class="promo-content">
                        ...
                        <p>To help people track their progress and plan daily routes, we will soon be launching our fitness tracker and trainer app on both iOS and Android platforms. We will also be constantly adding new chapters to our growing network of runners.</p>
                    </div>
                </div>
                <!-- /.promo-block-wrapper -->
            </div>
