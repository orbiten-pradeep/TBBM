...
<!-- .about-text-->
   ...
   <!--  <div class="container">
        <div class="row">
            <h2>Why Sponsor?</h2>
<p>Our sponsor partners will be highly visible and recognized in multiple arenas depending on the level 
of support </p><br>

<h2>Demographics </h2>
<p>
Runners tend to be educated and have a good income.  Running is now the fitness mantra for our 
citizens pre-dominantly between 20 to 50 year old range. 
</p><br>
<h2>Your Support Gives</h2>
<p>
The opportunity to associate your brand with premium event and experience.Exposure to thousands 
of participants.Greater market visibility through multiple media channels, on-site banners and 
printed materials.</p>
        </div> -->
        <!-- .row -->
    <!-- </div> -->
