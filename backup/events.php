...
var el =
'<div class="row parent-row"><input class="parentRowAmt" value="0" type="hidden" /><div class="col-xs-12 col-sm-3 col-lg-3 name-size mob-form-size">'+
  '<div class="form-group float-label-control label-bottom">'+
...
'<div class="form-group">'+
    // '<label for="">Gender</label>'+  
    ' <select class="form-control time-form select-time" id="time_lapse[]" name="time_lapse[]">'+
...
$("#elcontainer").on('change', '.select-km', function(e){
      ...
      if(val != ""){
        if(val == "10KM"){
          var fixedAmt = 650;
          parentRow.find(".select-time option").hide();
          parentRow.find(".select-time option[value=2:30]").show();
        }
        else if(val == "21.1KM"){
          var fixedAmt = 850;
        }
