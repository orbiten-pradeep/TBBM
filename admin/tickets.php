...
<div id="content" style="overflow: auto;">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Tickets Details</a> </div>
...
require'class/viewdetails.php';
      ...
      <tr class="table-row" id="row-<?php echo $row["ID"]; ?>"> 
        ...
        <td class="table-row"><?php echo $row["city"]; ?></td>
