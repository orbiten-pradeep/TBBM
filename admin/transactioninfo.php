  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="transaction.php"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> Transaction Details </a> </li>
        <!-- <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Charts</a> </li> -->
        <li class="bg_ly"> <a href="transuccess.php"> <i class="icon-inbox"></i><span class="label label-success">101</span>Success </a> </li>  <!-- <li class="bg_lb"> <a href="contactdetails.php"> <i class="icon-envelope-alt"></i>Contact-mail </a> </li> -->
             
        <li class="bg_lo"> <a href="tranfailure.php"> <i class="icon-th"></i>Failure</a> </li>
        <!-- <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Full width</a> </li> -->
        <li class="bg_lo span3"> <a href="paystatus.php"> <i class="icon-th-list"></i>Cancelled by user</a> </li>
