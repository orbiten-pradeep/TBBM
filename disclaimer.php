...
<section class="x-services ptb-100 gray-bg tbbm-section">
    ...
    <div class="container">
        <div class="row">
            ...
            The information is provided by Orbiten Technologies P. Ltd. and while we endeavor to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.
...
Through this website you are able to link to other websites which are not under the control of Orbiten Technologies P. Ltd. We have no control over the nature, content and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.

Every effort is made to keep the website up and running smoothly. However, Orbiten Technologies P. Ltd. takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
        </div>
        <!-- .row -->
    </div>
    <!-- .container -->
