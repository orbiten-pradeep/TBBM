  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="tickets.php"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> Ticket Details</a> </li>
        <!-- <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Charts</a> </li> -->
        <li class="bg_ly"> <a href="half.php"> <i class="icon-inbox"></i><span class="label label-success">101</span>Half Marathon </a> </li>  <!-- <li class="bg_lb"> <a href="contactdetails.php"> <i class="icon-envelope-alt"></i>Contact-mail </a> </li> -->
             
        <li class="bg_lo"> <a href="full.php"> <i class="icon-th"></i>Full Marathon</a> </li>
        <!-- <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Full width</a> </li> -->
        <li class="bg_lo span3"> <a href="ticsuccess.php"> <i class="icon-th-list"></i>Success</a> </li>
