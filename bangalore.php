...
<section class="x-services ptb-100 gray-bg tbbm-section">
    ...
    <section class="section-title">
        <div class="container text-center">
            <!-- <h2>Our Events</h2> -->
            <h1>The Big Beach Marathon - Bangalore</h1>
            <h3>Date</h3>
            <h3>Location</h3>
...
<section class="x-features" style="background: #f9f9f9;display: none;">
 ...
 <section id="bs-pricing-six" class="bs-pricing-four roomy-50 bg-white fix">
            <div class="container">
                ...
                <input id="city" type="hidden" name="city" value="Bangalore">
                    <button href="#" class="btn btn-lg btn-primary member-btn" disabled="true">Register Now</button>
                </div>
                </div> 
                </div>
            </div>
