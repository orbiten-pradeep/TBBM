...
&&($_FILES['image']['error'] == 0))
  ...
  $query = "UPDATE users SET profile = '$document', firstname ='$firstname', lastname='$lastname', DOB='$DOB', Gender='$Gender', ContactNumber='$ContactNumber', Height='$Height', Weight='$Weight', groupname='$groupname', blood='$blood' WHERE role = 'User'AND email='$email' ";
  if ($DBcon->query($query)) { 
