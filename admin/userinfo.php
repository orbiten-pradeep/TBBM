  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="adminhome.php"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> My Dashboard </a> </li>
        <!-- <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Charts</a> </li> -->
        <li class="bg_ly"> <a href="useractive.php"> <i class="icon-inbox"></i><span class="label label-success">101</span>Active Users </a> </li> 
        <li class="bg_lo"> <a href="userinactive.php"> <i class="icon-th"></i>Inactive Users</a> </li>
        <li class="bg_lo span3"> <a href="member.php"> <i class="icon-th-list"></i>Membership</a> </li>
      </ul>
    </div>
    <div class="row-fluid">
