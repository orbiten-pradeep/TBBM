...
//$_SESSION['transaction_success'] = "Ur Transaction Has Done Succesfully!!";
    ...
    foreach ($_POST['fullname'] as $key => $value) {
     ...
     if($KM == "10KM")
      {
      $query = "";
      $query = "INSERT INTO tickets(tickets, fullname,tshirt,KM,Bibno,gender,email,phone, transactions_id) VALUES('$tickets','$fullname','$tshirt','$KM','$half','$gender','$email','$phone','$trans_id')";
             if($DBcon->query($query) ) 
             {
    ...
    $_SESSION['ticket_error'] = "Sry Ur Tickets Are Not Booked!!!!";
      ...
      $query = "";
      $query = "INSERT INTO tickets(tickets, fullname,tshirt,KM,Bibno,gender,email,phone, transactions_id) VALUES('$tickets','$fullname','$tshirt','$KM','$Full','$gender','$email','$phone','$trans_id')";
             if($DBcon->query($query) ) {
          $_SESSION['ticket_success'] = "Ur Tickets has Booked!!";
