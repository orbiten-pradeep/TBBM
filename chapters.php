        ...
        <div class="row chapters-row">
                ...
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/chapters.jpg" alt="Image"></a>
                     ...
                     <div class="caption">
                        ...
                        <p>The capital city of Tamil Nadu has lovely expanses of beach and beachside roads that are a boon to its large fitness population. Our chapter in Chennai links different runners and aspiring runners from all parts of Chennai to plan routes and get to fitness.</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption">
                        ...
                        <p>The Garden City already has a large population of runners. Our Bengaluru chapter aims to link this large group for better information exchange, tips, training schedules, and route mapping.</p>
                        <!-- <button class="btn btn-primary pull-right">View More</button> -->
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-4">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption">
                        ...
                        <p>Pune, is a fast-growing IT hub with people from all over India working there as well. Our Pune chapter Helps runners from Pune link with runners who are there just for work to ensure ease of access to running routes and schedules.</p>
                        <!-- <button class="btn btn-primary pull-right">View More</button> -->
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-4">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption">
                        <h3><a href="#">Big Beach runners - Mumbai</a></h3>

                        <p>In the city of Bollywood where almost every superstar is a fitness freak, it’s no surprise that the people are into fitness too. Our chapter here is in its infancy but with huge growth potential and a large population, the sky is the limit.</p>
                        <!-- <button class="btn btn-primary pull-right">View More</button> -->
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption">
                        <h3><a href="#">Big Beach runners - Goa</a></h3>

                        <p>Goa is famous for its mile-long beaches and its bustling night life but what most people do not know is that fitness is life for most people here. Our Goa chapter helps these runners get ready for life!</p>
                        <!-- <button class="btn btn-primary pull-right">View More</button> -->
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="thumbnail clearfix">
                    ...
                    <div class="caption">
                        <h3><a href="#">Big Beach runners - Pondicherry</a></h3>

                        <p>The quaint little beachside town has one startling revelation – every resident is into fitness of some kind! Our chapter here is in its infancy and raring to go!</p>
                        <!-- <button class="btn btn-primary pull-right">View More</button> -->
                    </div>
                </div>
            </div>
